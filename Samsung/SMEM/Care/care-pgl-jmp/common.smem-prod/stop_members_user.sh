...
curl -X POST 30.0.152.96:$java_port/management/pause
curl -X POST 30.0.152.96:$java_port/management/service-registry?status=DOWN --header 'Content-Type:application/json'
sleep 90
# sleep 90
